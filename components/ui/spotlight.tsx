...
/** Mouse-following radial spotlight. Attaches to its positioned parent. */
export function Spotlight({ className, size = 360, springOptions = { bounce: 0 } }: SpotlightProps) {
  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        "bg-[radial-gradient(circle_at_center,rgba(244,180,0,0.28),transparent_70%)]",
